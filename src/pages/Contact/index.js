...
const Contact = () => {
  ...
  const onSubmit = useCallback(
    async event => {
      ...
      try {
        ...
        const response = await fetch('https://marvelous-milos.herokuapp.com/message', {
          method: 'POST',
          mode: 'cors',
          headers: {
  ...
  return (
    <Section className={classNames('contact', `contact--${status}`)}>
      <Helmet>
        <title>Contact | Milos Jovanovic</title>
        <meta
          name="description"
                            ...
                            <div className="contact__form-error-message">
                              ...
                              <ul className="contactInfo">
                                <li>
                                  <Link>Address </Link> 
                                  <DecoderText
                                    text="Sterije Popovica 6, Vranje Serbia"
                                    start={status !== 'exited' && !prerender}
                                    delay={300}
                                  />
                                </li>
                                <li>
                                  <Link>Email </Link> 
                                  <DecoderText
                                    text="babystar.shine2019@gmail.com"
                                    start={status !== 'exited' && !prerender}
                                    delay={300}
                                  />
                                </li>
