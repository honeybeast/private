...
const Home = () => {
  ...
  return (
    <div className="home">
      <Helmet>
        <title>Milos Jovanovic | Designer + Developer</title>
        <meta
          name="description"
          content="Portfolio of Milos Jovanovic – a digital designer working on web &amp; mobile
      ...
      <ProjectSummary
        ...
        description="Design and develop the most competitive and high-quality website."
      ...
      <ProjectSummary
        ...
        description="Design and develop the modern and user-friendly Mobile and ios App."
      ...
      <ProjectSummary
        ...
        index={3}
        title="Desktop App Design and Development"
        description="Design and develop powerful and cross-platform software."
        buttonText="View Project"
