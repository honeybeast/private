...
const Uses = () => {
  ...
  return (
    <Fragment>
      <Helmet>
        <title>Uses | Milos Jovanovic</title>
        <meta
          name="description"
      ...
      <ProjectContainer className="uses">
        ...
        <ProjectHeader
          title="Service"
          description="A somewhat comprehensive list of technology, tools, apps, hardware, and more that I use on a daily basis to design and code things. And yeah, that is a Johnny Mnemonic GIF in the background."
        />
            ...
            <ProjectTextRow width="m">
              ...
              <ProjectSectionText>
                <ul>
                  ...
                  <li>
                    eCommerce, Shopify, Prestashop, Magento, Woocommerce
                  </li>
                  <li>
                    Stripe, PayPal, PayU Money integration
                  </li>
                  <li>
                    Google map & Geo API, Social API, Restful API
                  </li>
                  <li>
                    AWS, Git, Trello, Firebase
                  </li>
                  <li>
                    Android (Java, Kotlin)
                  </li>
